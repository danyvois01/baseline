...
import { OfficialRankingEntry } from "@/lib/mock-data-official";
...
export function OfficialClient({ initialRankings, lastUpdated }: OfficialClientProps) {
  ...
  return (
    <>
      ...
      <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4 mb-6">
        ...
        <div>
          ...
          <p className="text-body-lg text-deep-navy/70 font-medium flex items-center gap-2">
            <span className="w-1 h-5 bg-[#DFFF00] rounded-full inline-block" />
      ...
      <OfficialTable entries={filteredRankings} initialCount={20} />
    </>
  );
}
