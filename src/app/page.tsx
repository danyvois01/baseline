          ...
          <div className="relative w-full max-w-5xl mx-auto bg-deep-navy rounded-[32px] sm:rounded-[48px] py-16 sm:py-20 overflow-hidden shadow-2xl border border-white/10">
            ...
            <div className="relative mx-auto max-w-[800px] px-6 text-center z-10 flex flex-col items-center">
              <div className="inline-block bg-white/5 backdrop-blur-md px-5 py-1.5 rounded-full mb-6 border border-white/10 shadow-sm">
                <span className="text-[#DFFF00] font-bold tracking-widest uppercase text-xs">{t.home.cta.badge}</span>
              </div>
              
              <h2 className="text-[36px] sm:text-[48px] md:text-[60px] font-heading font-black text-white mb-5 leading-[1.1] tracking-tight">
                {t.home.cta.titleLine1} <br className="hidden sm:block"/> {t.home.cta.titleLine2}
              </h2>
              ...
              >
                ...
                <span className="relative z-10 uppercase tracking-wide">{t.home.cta.button}</span>
              </Link>
            </div>
          </div>
        </section>
