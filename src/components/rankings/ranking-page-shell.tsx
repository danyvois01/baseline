...
export function RankingPageShell<T extends HasPlayer>({
  ...
  const toolbar = (
    <div className="flex flex-wrap items-center gap-3 px-4 md:px-6 py-4 border-b border-border-subtle bg-surface-gray/20">
      ...
      {/* Spacer pushes search+filter to the right */}
      ...
      <div className="relative">
        ...
        <input
          ...
          className="pl-10 pr-4 py-2.5 rounded-full border border-border-subtle bg-surface-white text-sm focus:outline-none focus:ring-2 focus:ring-baseline-lime focus:border-transparent transition-all w-40 md:w-48 lg:w-56 placeholder:text-text-muted text-foreground"
        />
      </div>

      {/* Filter Popover */}
      <Popover>
        <PopoverTrigger className="relative inline-flex items-center gap-2 rounded-full border border-border-subtle bg-surface-white px-5 py-2.5 text-sm font-medium text-foreground transition-all duration-200 hover:bg-surface-hover cursor-pointer">
